...
def sample_scaler():
    ...
    print_matrix(standardized_data)
...
def sample_pca():
    ...
    print_matrix(pca.components)
    print("Explained Variance:")
    print_vector(pca.explained_variance)
